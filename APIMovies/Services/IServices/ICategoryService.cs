...
namespace APIMovies.Services.IServices
{
    public interface ICategoryService
    {
        ...
        Task<CategoryDto> CreateCategoryAsync(CategoryCreateUpdateDto categoryCreateDto); //Me crea una categoria
        Task<CategoryDto> UpdateCategoryAsync(CategoryCreateUpdateDto categoryUpdateDto, int id); //Me crea una categoria --puedo actualizar el nombre y la fecha de actualizacion
